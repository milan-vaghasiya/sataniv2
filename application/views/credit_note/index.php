            ...
            <div class="col-sm-12">
				<div class="page-title-box">
					<div class="float-end">
                        ...
                        onclick="window.location.href='<?=base_url($headData->controller.'/addCreditNote')?>'"><i class="fa fa-plus"></i> Add Credit Note</a>
					</div>
					...
					<div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id='creditNoteTable' class="table table-bordered ssTable ssTable-cf" data-url='/getDTRows'></table>
                            </div>
                        </div>
					</div>
				</div>
