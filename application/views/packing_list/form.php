        ...
        <div class="row">
            <div class="col-12">
				<div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form autocomplete="off" id="savePackingList" data-res_function="resPackingList" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    <div class="row">
                                                ...
                                                <table id="packingListItems" class="table table-striped table-borderless">
                                                    ...
                                                    <tfoot class="thead-dark">
                                                        <tr>
                                                            ...
                                                            <th id="total_pallet_qty">0</th>
                                                            <th id="total_net_weight">0</th>
                                                            <th id="total_gross_weight">0</th>
                                                            <th></th>
                                                            <th></th>
                                                        </tr>
                                                    </tfoot>
                        ...
                        <div class="card-footer bg-facebook">
                            <div class="col-md-12"> 
                                <button type="button" class="btn waves-effect waves-light btn-success float-right save-form" onclick="customStore({'formId':'savePackingList'});" ><i class="fa fa-check"></i> Save </button>
                ...
                <form id="itemForm">
                    <div class="col-md-12" >
                        <div class="row form-group">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="item_desc">Box Name</label>
                                <input type="text" name="item_desc" id="item_desc" class="form-control req" value="">
                            </div>
                            <div class="col-md-2 form-group">
...
<script src="<?php echo base_url(); ?>assets/js/custom/packing-list-form.js?v=<?= time() ?>"></script>
