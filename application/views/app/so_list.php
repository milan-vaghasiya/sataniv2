<?php
	...
	if(!empty($soData))
	{
		...
		{
			$approveParam = "{'postData':{'id':".$row->id.",'is_approve': 1,'msg':'Approved'},'message':'Are you sure want to Approve this Sales Order?','fnsave':'approveSalesOrder','res_function':'getOrderResponse'}";
			$soDetail .= '<li class=" grid_item listItem item transition position-static data-category="transition">
								...
								<div class="left-content w-auto">
									...
									<div class="d-flex mt-2">
										<a class="float-end font-20" href="'.base_url('salesOrders/printOrder/'.$row->id).'" target="_blank"><i class="fa fa-print"></i></a>
									</div>
								</div>
