			...
			<div class="container">
				<div class="header-content">
					<div class="left-content">
						...
						<h5 class="title mb-0 text-nowrap"  id="desk_title">Requisions</h5>
					</div>
        ...
        <div class="content-inner pt-0" >
			<div class="container">
                ...
                <div class="review-box" >
					<a  href="<?=base_url("app/materialIssue/issueMaterial/")?>" class="add-btn  permission-write" style="margin-bottom:80px">
...
$(document).ready(function(){
	...
	$(document).on('click','.stageFilter',function(){
		...
		postdata.page = 0;
		loadHtmlData({'fnget':'getMaterialIssueData','rescls':'issueData','postdata':postdata});
	});
	...
	$(scrollEle).scroll(function() {
		...
		if($(this).scrollTop() + $(this).innerHeight() >= ($(this)[0].scrollHeight - 10)) {
			if(ScrollDebounce){
				...
				loadHtmlData({'fnget':'getMaterialIssueData','rescls':'issueData','postdata':postdata,'scroll_type':1});
				setTimeout(function () { ScrollDebounce = true; }, 500);		
			}
		}
	});
	
	$(document).on("click", "ul.issueData li span.delete", function () {alert("delete");});
	$(document).on("click", "ul.issueData li span.flag", function () {alert("flag");});
	$(document).on("click", "ul.issueData li span.more", function () {alert("nothing");});
