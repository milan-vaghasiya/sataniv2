                    ...
                    <div class="card-header">
                        <div class="row">
							<div class="col-md-4">
								...
								<a href="<?=base_url("hr/salaryStructure/heads")?>" class="btn btn-outline-primary waves-effect waves-light active">Salary Heads</a>
							</div>
                            ...
                            <div class="col-md-4">
								<?php
									$addParam = "{'modal_id' : 'modal-md', 'call_function':'addSalaryHead', 'form_id' : 'addSalaryHead', 'title' : 'Add Salary Head', 'fnsave' : 'saveSalaryHead'}";
								?>
