        ...
        <div class="row">
            <div class="col-sm-12">
				<div class="page-title-box">
					...
					<div class="float-end">
					    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-outline-dark float-right permission-write press-add-btn" data-txt_editor="conditions" onclick="window.location.href='<?=base_url($headData->controller.'/addChallan')?>'"><i class="fa fa-plus"></i> Add Challan</a>
					</div>
				</div>
            </div>
		</div>
