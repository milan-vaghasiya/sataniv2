            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 text-center"> <h4 class="card-title">Monthly Attendance</h4></div>
							<hr>
						</div class="row">
						<div>
							<div class="col-md-12">
                                <div class="input-group">
									...
									<div class="input-group-append"  style="width:25%;margin-bottom:0px;">
										<select name="biomatric_id" id="biomatric_id" class="form-control select2 req">
											<?php
									...
									<div class="input-group-append" style="width:10%;margin-bottom:0px;">
										<button type="button" class="btn btn-block waves-effect waves-light btn-warning float-right" title="Load Data"  onclick="printMonthlySummary('excel');"><i class="fa fa-file-excel"></i> Excel</button>
									</div>
									<div class="input-group-append" style="width:10%;margin-bottom:0px;" >
										<button type="button" class="btn btn-block waves-effect waves-light btn-primary float-right" title="Load Data" onclick="printMonthlySummary('pdf');"><i class="fa fa-file-pdf"></i> PDF</a>
									</div>
								</div>
                            </div>                        
                        </div>                                         
