...
class StoreLocation extends MY_Controller{
    ...
    private $editStoreForm = "store_location/main_form";
    ...
    public function save(){
        ...
        if(empty($data['store_name']) && empty($data['ref_id']))
        ...
        if($data['mainstore_level'] != ""):
            ...
            $mainStore = $this->storeLocation->getStoreLocation(['store_level'=>$data['mainstore_level']]);
    ...
    /*Created By @Raj 22-08-2024*/
	public function editStoreLocation(){
		$data = $this->input->post();
		$this->data['dataRow'] = $this->storeLocation->getStoreLocation($data);
        $this->load->view($this->editStoreForm, $this->data);
	}
	...
	public function editLocation(){
        ...
        if(!empty($errorMessage)):
            ...
            $this->printJson($this->storeLocation->editLocation($data));
        endif;
	}
}
?>